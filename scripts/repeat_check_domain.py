...
TEST_CASES = [
    ...
    # eval_classification_accuracy.py 실측(89건)에서 새로 발견된 technical->admin 오분류
    # 후보 6건 - "구체적 수치/규격을 묻는 짧고 사무적인 문장" 패턴이 공통적으로 보임
    ("H01", "전압 종합고조파왜형률(THD)의 국내외 허용 기준은 얼마인가요?", "technical"),
    ("G06", "Mesh 접지에 IEEE-80 기준을 적용해서 피뢰접지랑 연결해도 되나요?", "technical"),
    ("P2-05", "CT(변류기) 구동 중 2차측을 개방(Open)하면 고전압이 발생하여 소손되는 전력학적 원리는 무엇인가요?", "technical"),
    ("P2-06", "CT 2차를 열어놓으면 왜 위험한가요?", "technical"),
    ("BP-02", "전기안전관리자가 가로등 접지공사할 때 접지저항 기준이 몇 옴 이하여야 하나요?", "technical"),
    ("BP-03", "감리원이 활선 상태에서 절연저항을 측정하기 어려울 때 대신 확인할 수 있는 기준이 있나요?", "technical"),
]
